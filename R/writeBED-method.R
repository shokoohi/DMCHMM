...
setMethod("writeBED",
    signature=c(object="BSData", name="character", file="character"),
    .writeBED_BSData)

#' @rdname writeBED-method
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSData", name="character", file="missing"),
    function(object, name) {
    .writeBED_BSData(object, name=name,
...
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSData", name="missing", file="character"),
...
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSData", name="missing", file="missing"),
    function(object) {
...
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSDMCs", name="character", file="character"),
    .writeBED_BSDMCs)

#' @rdname writeBED-method
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSDMCs", name="character", file="missing"),
    function(object, name) {
    .writeBED_BSDMCs(object, name=name,
    file=paste(colnames(object), ".bed", sep=""))
    })
...
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSDMCs", name="missing", file="character"),
    function(object, file) {
...
#' @aliases writeBED-method writeBED
setMethod("writeBED",
    signature=c(object="BSDMCs", name="missing", file="missing"),
    function(object) {
